...
var _require6 = __webpack_require__(9),
    showLoadContent = _require6.showLoadContent;
...
$.when(authUser(clientToken)).then(function (res) {
  ...
  module.exports = { connection: connection, userObject: userObject };
}).catch(function (e) {
...
moment.tz.load(__webpack_require__(133));
